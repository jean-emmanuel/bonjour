...
var proto = {
  ...
  updateName: function(){
    ...
    this.host = this.originalHost.split('.local')[0]+'_'+this.conflictCount+'.local';
    this.fqdn = this.name+'_'+this.conflictCount + '.' + this.type + TLD
    this.packet = this._records();

    // console.log('Trying with: ', this.host);
